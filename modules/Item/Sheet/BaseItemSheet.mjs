  ...
  async _prepareContext(options) {
    ...
    for ( const [groupId, groupData] of Object.entries(this.constructor.TABS) ) {
      context.tabs[groupId] = {
        content: this._prepareTabs("sheet"),
        html: await foundry.applications.handlebars.renderTemplate(groupData.template ?? SystemConsts.TEMPLATES_PATH + "/models/tabs.hbs", {
          id: groupId,
          ...groupData,
          cssClasses: groupData.classes ? groupData.classes.join(" ") : "",
        })
      };
    }
